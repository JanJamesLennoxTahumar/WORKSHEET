...
DATA <- read_excel("C:\\Users\\User\\Desktop\\Taws\\Worksheets\\Worksheet#7//Breast_Cancer.xlsx")
DATA
```
...
```{}
library(xlsx)
write.xlsx("abalone","C:\\Users\\User\\Desktop\\Taws\\Worksheets\\Worksheet#7\\abalone.xlsx")
```