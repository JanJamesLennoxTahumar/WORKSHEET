...
pie(expenses, main = "Expenses",col=rainbow(length(expenses)),labels = ex_labels,cex=0.8)
    ...
    NUMBER_3A <-hist(numb3, xlab="Miles Per Gallon",
                  main="Histogram of mpg")
    
    
    #b. Colored histogram with different number of bins.
    NUMBER_3B <-hist(numb3, breaks=12, col="red", xlab="Miles Per Gallon",
                  main="Histogram of mpg")
    ...
    NUMBER_3C <-hist(numb3, breaks=12, col="red", xlab="Miles Per Gallon",
